...
public class ProdutoDAO {
	...
	static {
		PRODUTOS.put("R2D2", new Produto("R2-D2","Porta café R2-D2","https://www.thinkgeek.com/images/products/frontsquare/itns_r2-d2_coffee_press.jpg",new BigDecimal(99.99)));
		...
		PRODUTOS.put("CANECAYODA", new Produto("YODA","Caneca Yoda", "http://www.thinkgeek.com/images/products/frontsquare/ilgs_sw_yoda_heat_change_mug.gif",new BigDecimal(80)));
